...
#SBATCH -J CentralLineTraining

### (Optional)
### If you'd like to give a bit more information about your job, you can
### use the command below.
##SBATCH --comment='Training a naive NN on averaged GloVe embeddings for NNs'
...
#SBATCH -o /home/pkinne2/cluster-logs/Training/file-%A.out
#SBATCH -e /home/pkinne2/cluster-logs/Training/file-%A.err
...
#SBATCH --mail-user=phillkin@gmail.com
...
hostname
scl enable rh-python36 "python Training_nb.py"